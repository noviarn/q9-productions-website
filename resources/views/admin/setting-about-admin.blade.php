...
<div class="report-container">
  ...
  <div class="report-body">
    <div class="grid-container">
        ...
        <form method="post" action="{{ route('about.post', $about->id)}}" enctype="multipart/form-data">
        {{csrf_field()}} 
          <div class="item2">
            <h1>About Setting</h1>
              ...
              <div class="section">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="sec1_title" name="sec1_title" placeholder="input title..." value="{{$about->sec1_title}}" required>
                </div>
                <div class="form-group">
                  <label for="sec1_subtitle">Subtitle</label>
                  <input type="text" id="sec1_subtitle" name="sec1_subtitle" placeholder="input subtitle..."  value="{{$about->sec1_subtitle}}" required>
                </div>
                <div class="form-group">
                  <label for="sec1_isi_konten">Detail Content</label>
                  <input type="text" id="sec1_isi_konten" name="sec1_isi_konten" placeholder="input detail content..."   value="{{$about->sec1_isi_konten}}"required>
                </div>
                <div class="form-group">
                  <div div class="label">
                  ...
                  <div>Selected image: {{$about->sec1_img}}</div>
              ...
              <div class="section">
                <h3>Section 2</h3>
                  <div class="form-group">
                    ...
                    value="{{$about->sec2_title}}" required>
                  </div> 
                  <div class="form-group">
                    <div div class="label">
                      <label for="image">Image:</label>
                    ...
                    <div>Selected image: {{$about->sec2_img1}}</div>
                  ...
                  <div class="form-group">
                    ...
                    <div>Selected image: {{$about->sec2_img2}}</div>
