  ...
  <body>
    ...
    <header class="navbar">
      ...
      <a href="home.html" class="logo"
        ><img src="<?php echo e(asset('img/q9-logo-without-text-new.png')); ?>" alt="Q9 Productions logo"
      /></a>
      <nav class="nav-links">
          ...
          <div class="contact-info">
            <div class="box">
              <div class="icon">
                <img
                  class="img"
                  src="<?php echo e(asset('img/icons/white/ic_sharp-phone.svg')); ?>"
                  alt="Phone contact icon"
                />
              </div>
              <div class="text">
                <a href="tel:+628119847234"> <p><?php echo e($contact->whatsapp); ?></p></a>
              </div>
            </div>
            <div class="box">
              <div class="icon">
                <img
                  class="img"
                  src="<?php echo e(asset('img/icons/white/ic_sharp-email.svg')); ?>"
                  alt="Email contact icon"
                />
              </div>
              <div class="text">
                <a href="mailto:ops.q9p@gmail.com"> <p><?php echo e($contact->email); ?></p></a>
              </div>
            </div>
            <div class="box">
              <div class="icon">
                <img
                  class="img"
                  src="<?php echo e(asset('img/icons/white/ri_instagram-fill.svg')); ?>"
              ...
              <div class="text">
                <a
                  ...
                  target="”_blank"
                  ><p><?php echo e($contact->instagram); ?></p></a
                >
              </div>
            </div>
            <div class="box">
              <div class="icon">
                <img
                  class="img"
                  src="<?php echo e(asset('img/icons/white/uil_facebook-f.svg')); ?>"
              ...
              <div class="text">
                <a
                  ...
                  target="”_blank"
                >
                  <p><?php echo e($contact->facebook); ?></p></a
                >
              </div>
            </div>
          </div>
...
<?php /**PATH C:\xampp\htdocs\q9production-project\resources\views/contact-us.blade.php ENDPATH**/ ?>